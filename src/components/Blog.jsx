...
const Blog = () => {
    ...
    return (
        <div  className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-12' id='faq'>
            ...
            Exploring CSR Initiatives
            </h2>
            <p className="text-sm text-neutralGrey mb-8 md:w-3/4 mx-auto">
            Dive into the latest insights and trends in corporate social responsibility (CSR). Discover how businesses are making a positive impact on society through their CSR initiatives.
            </p>
            </motion.div>
                    ...
                    blogs.map( blog => <div key={blog.id} className='mx-auto relative mb-12 cursor-pointer'>
                       <img src={blog.image} alt="" className='mx-auto hover:scale-95 transition-all duration-300'/>
                        ...
                        <div className='text-center px-4 py-8 bg-white shadow-lg rounded-md md:w-3/4 mx-auto absolute -bottom-12 left-0 right-0'>
                            ...
                            <a href="/" className="font-bold text-blue-800 hover:text-neutralBlack px-3 py-1 rounded-lg">
